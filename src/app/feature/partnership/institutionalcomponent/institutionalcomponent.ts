...
@Component({
  selector: 'app-institutionalcomponent',
  standalone: false,
  templateUrl: './institutionalcomponent.html',
  styleUrl: './institutionalcomponent.css',
})
  ...
  ngOnInit() {
   ...
   loadData() {
     this.isLoading = true;
       ...
       this.service.findByGovCategory('Education').subscribe({
